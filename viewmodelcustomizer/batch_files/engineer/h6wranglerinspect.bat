set "xIn=wrangler_inspect.qc"
set "xOut=wrangler_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "wrangler_inspect.snap" "wrangler_inspect.done.snap"
move "wrangler_inspect.done.snap" "wrangler_inspect.qc"