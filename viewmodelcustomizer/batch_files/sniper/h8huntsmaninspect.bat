set "xIn=huntsman_inspect.qc"
set "xOut=huntsman_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "huntsman_inspect.snap" "huntsman_inspect.done.snap"
move "huntsman_inspect.done.snap" "huntsman_inspect.qc"