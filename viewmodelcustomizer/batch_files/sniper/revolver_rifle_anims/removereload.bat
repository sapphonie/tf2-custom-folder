:set input file
set inputanimation=rifolver_idle.smd
:set output files (up to 8)
set outputanimation1=rifolver_fire_reload.smd
set outputanimation2=PLACEHOLDER.smd
set outputanimation3=PLACEHOLDER.smd
