set "xIn=bread_jar_inspect.qc"
set "xOut=bread_jar_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "bread_jar_inspect.snap" "bread_jar_inspect.done.snap"
move "bread_jar_inspect.done.snap" "bread_jar_inspect.qc"