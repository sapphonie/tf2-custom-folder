...
:confirmed
:set input file
set inputanimation=knife_idle.smd
:set output files (up to 8)
set outputanimation1=knife_backstab_down.smd
set outputanimation2=knife_backstab_idle.smd
set outputanimation3=knife_backstab_up.smd
