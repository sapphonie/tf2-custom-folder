set "xIn=bread_inspect.qc"
set "xOut=bread_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "bread_inspect.snap" "bread_inspect.done.snap"
move "bread_inspect.done.snap" "bread_inspect.qc"