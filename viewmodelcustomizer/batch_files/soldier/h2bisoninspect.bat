set "xIn=bison_inspect.qc"
set "xOut=bison_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "bison_inspect.snap" "bison_inspect.done.snap"
move "bison_inspect.done.snap" "bison_inspect.qc"