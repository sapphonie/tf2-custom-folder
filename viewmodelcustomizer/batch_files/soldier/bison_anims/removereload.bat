:set input file
set inputanimation=bison_idle.smd
:set output files (up to 8)
set outputanimation1=bison_reload_end.smd
set outputanimation2=bison_reload_loop.smd
set outputanimation3=bison_reload_start.smd
