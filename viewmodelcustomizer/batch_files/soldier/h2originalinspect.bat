set "xIn=original_inspect.qc"
set "xOut=original_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "original_inspect.snap" "original_inspect.done.snap"
move "original_inspect.done.snap" "original_inspect.qc"