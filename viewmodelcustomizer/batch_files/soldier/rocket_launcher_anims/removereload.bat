...
set outputanimation1=dh_reload_finish.smd
set outputanimation2=dh_reload_finish_alt.smd
set outputanimation3=dh_reload_loop.smd
set outputanimation4=dh_reload_loop_alt.smd
set outputanimation5=dh_reload_start.smd
set outputanimation6=dh_reload_start_alt.smd
