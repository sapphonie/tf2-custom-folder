:set input file
set inputanimation=bet_idle.smd
:set output files (up to 8)
set outputanimation1=bet_reload_finish.smd
set outputanimation2=bet_reload_loop.smd
set outputanimation3=bet_reload_start.smd
