set "xIn=boxing_gloves.qc"
set "xOut=boxing_gloves.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "boxing_gloves.snap" "boxing_gloves.done.snap"
move "boxing_gloves.done.snap" "boxing_gloves.qc"