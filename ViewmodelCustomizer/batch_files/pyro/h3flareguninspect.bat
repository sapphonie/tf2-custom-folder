set "xIn=flaregun_inspect.qc"
set "xOut=flaregun_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "flaregun_inspect.snap" "flaregun_inspect.done.snap"
move "flaregun_inspect.done.snap" "flaregun_inspect.qc"