set "xIn=shortstop_inspect.qc"
set "xOut=shortstop_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "shortstop_inspect.snap" "shortstop_inspect.done.snap"
move "shortstop_inspect.done.snap" "shortstop_inspect.qc"