set "xIn=cleaver_inspect.qc"
set "xOut=cleaver_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "cleaver_inspect.snap" "cleaver_inspect.done.snap"
move "cleaver_inspect.done.snap" "cleaver_inspect.qc"