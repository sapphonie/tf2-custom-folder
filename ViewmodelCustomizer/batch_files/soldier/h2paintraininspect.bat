...
set "xOut=pain_train_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "pain_train_inspect.snap" "pain_train_inspect.done.snap"
move "pain_train_inspect.done.snap" "pain_train_inspect.qc"