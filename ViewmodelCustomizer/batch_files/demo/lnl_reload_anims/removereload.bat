:set input file
set inputanimation=g_idle.smd
:set output files (up to 8)
set outputanimation1=loch_reload_end.smd
set outputanimation2=loch_reload_loop.smd
set outputanimation3=loch_reload_start.smd
