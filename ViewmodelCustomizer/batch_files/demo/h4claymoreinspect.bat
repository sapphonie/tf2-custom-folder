set "xIn=claymore_inspect.qc"
set "xOut=claymore_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "claymore_inspect.snap" "claymore_inspect.done.snap"
move "claymore_inspect.done.snap" "claymore_inspect.qc"