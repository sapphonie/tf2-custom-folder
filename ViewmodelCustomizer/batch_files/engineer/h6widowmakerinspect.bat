...
set "xOut=widowmaker_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "widowmaker_inspect.snap" "widowmaker_inspect.done.snap"
move "widowmaker_inspect.done.snap" "widowmaker_inspect.qc"