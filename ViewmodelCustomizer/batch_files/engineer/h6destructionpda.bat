set "xIn=destruction_pda.qc"
set "xOut=destruction_pda.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "destruction_pda.snap" "destruction_pda.done.snap"
move "destruction_pda.done.snap" "destruction_pda.qc"