:set input file
set inputanimation=pomson_idle.smd
:set output files (up to 8)
set outputanimation1=pomson_reload_end.smd
set outputanimation2=pomson_reload_loop.smd
set outputanimation3=pomson_reload_start.smd
