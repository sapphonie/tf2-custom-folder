set "xIn=detcheck.txt"
set "xOut=detcheck.useless"
...
:confirmed
:set input file
set inputanimation=eternal_idle.smd
:set output files (up to 8)
set outputanimation1=eternal_backstab_down.smd
set outputanimation2=eternal_backstab_idle.smd
set outputanimation3=eternal_backstab_up.smd
