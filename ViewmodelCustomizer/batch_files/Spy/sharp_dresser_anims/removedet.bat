...
:confirmed
:set input file
set inputanimation=acr_idle.smd
:set output files (up to 8)
set outputanimation1=acr_backstab_down.smd
set outputanimation2=acr_backstab_idle.smd
set outputanimation3=acr_backstab_up.smd
