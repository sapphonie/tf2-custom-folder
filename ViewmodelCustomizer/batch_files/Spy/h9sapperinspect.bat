set "xIn=sapper_inspect.qc"
set "xOut=sapper_inspect.snap"
set "xTerm=activity"
set "xInsert=snap"
...
copy "hide.txt" + "sapper_inspect.snap" "sapper_inspect.done.snap"
move "sapper_inspect.done.snap" "sapper_inspect.qc"